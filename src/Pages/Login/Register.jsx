...
const Register = () => {
    return (
        <section className='m-20'>
            <div class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl " style={{
            backgroundImage: `url("https://images.singletracks.com/blog/wp-content/uploads/2019/09/DarkBG_00_CAPRA29_SE_Front.jpg")`,
        }}   >
            {/* <div class="hidden bg-cover lg:block lg:w-3/5 opacity-50 "
       
        > </div> */}

            <div class="mx-auto w-full px-6 py-8 md:px-8 lg:w-1/2">
                ...
                <form>
                    <div class="mt-4">
                        <div class="flex justify-between">
                            <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200" for="loggingPassword">Full Name</label></div>
                    ...
                    <div class="mt-4">
                        <div class="flex justify-between">
                            <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200" for="loggingPassword">Email</label></div>
                    ...
                    <div className='mt-4'>
                    <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200" for="loggingPassword">Select Role</label>
                ...
                <div class="flex items-center justify-between mt-4">
                    ...
                    <Link to="/register" class=" font-bold text-xs text-blue-700 uppercase dark:text-blue-700 hover:underline"> sign In</Link>
