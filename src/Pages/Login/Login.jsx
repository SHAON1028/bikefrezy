    ...
    return (
      <section className='mt-20 mb-20'>
        ...
        <div class="mx-auto w-full px-6 py-8 md:px-8 lg:w-1/2">
            ...
            <Link onClick={handleGoogleSignIn}  to="#" class="flex items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                <div class="px-4 py-2">
           ...
           <div class="mt-4">
            ...
            <div class="flex items-center justify-between mt-4">
                ...
                <Link to="/register" class=" font-bold text-xs text-blue-700 uppercase dark:text-blue-700 hover:underline">or sign up</Link>
